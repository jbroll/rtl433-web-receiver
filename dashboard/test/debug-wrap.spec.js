...
test("check wrapping", async ({ page }) => {
  ...
  fvData.forEach(d => {
    console.log(`Text: "${d.text}", Font: ${d.fontSize}, Client: ${d.clientWidth}, Scroll: ${d.scrollWidth}, Wrap: ${d.scrollWidth > d.clientWidth}, Style: ${d.style}`);
  });
});
