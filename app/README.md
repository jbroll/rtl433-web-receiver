...
A Capacitor 8 shell around the [dashboard](../dashboard/README.md). It is not a second UI: the dashboard's self-contained `dist/index.html` is loaded directly by the WebView.
